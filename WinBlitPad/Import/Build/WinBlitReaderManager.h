...
EXTERN_C const IID IID_IWinBlitReader;
    ...
    typedef struct IWinBlitReaderVtbl
    {
        ...
        /* [helpstring][id][propput] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *put_DemoMode )( 
            IWinBlitReader __RPC_FAR * This,
            /* [in] */ long newVal);
        
        /* [helpstring][id][propget] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *get_DemoMode )( 
            IWinBlitReader __RPC_FAR * This,
            /* [retval][out] */ long __RPC_FAR *pVal);
...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE IWinBlitReader_get_State_Proxy( 
    IWinBlitReader __RPC_FAR * This,
    /* [retval][out] */ long __RPC_FAR *pVal);


void __RPC_STUB IWinBlitReader_get_State_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id][propput] */ HRESULT STDMETHODCALLTYPE IWinBlitReader_put_DemoMode_Proxy( 
    IWinBlitReader __RPC_FAR * This,
    /* [in] */ long newVal);


void __RPC_STUB IWinBlitReader_put_DemoMode_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE IWinBlitReader_get_DemoMode_Proxy( 
    IWinBlitReader __RPC_FAR * This,
    /* [retval][out] */ long __RPC_FAR *pVal);


void __RPC_STUB IWinBlitReader_get_DemoMode_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
